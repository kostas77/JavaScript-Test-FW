...
export class TestData implements ITestData {
    ...
    constructor() {
        ...
        switch (this.testEnv) {
            case 'dev':
                this.healthStoreUri = 'https://eu.dev.eu.regional.elsevier.com';
                break;
            case 'staging':
                this.healthStoreUri = 'https://eu.staging.eu.regional.elsevier.com';
                break;
            case 'production':
                this.healthStoreUri = 'https://www.eu.elsevierhealth.com';
                break;
            default:
...
export const customer: CustomerDetails = { ...addresses.SA.billing , ...{
    emailAddress: 'test.elsevier.io+eu@gmail.com',
    password: 'Spoon123'
} };
...
export const prodCustomer = {
    firstName: 'Prince',
    lastName: 'Salman',
    emailAddress: `test.elsevier.io+eu${new Date().getTime().toString()}@gmail.com`,
    password: 'Spoon123'
};
