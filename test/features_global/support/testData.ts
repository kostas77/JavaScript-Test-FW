...
import {
    IProductToPurchase,
    IDeltaRenewalToPurchase,
    IArgiOrAirBusinessRenewalToPurchase
} from '../../common/support/interfaces';
import { UserData } from './userData';
import { DriverConfig } from './driverConfig';
import { ITestData } from '../../common/support/interfaces';

export class TestData implements ITestData {

    protected testEnv: Environment;
    protected testUrl: UrlData;
    protected testUser: UserData;

    constructor() {
        this.testEnv = DriverConfig.getEnv();
        this.testUrl = new UrlData(this.testEnv);
        this.testUser = new UserData(this.testEnv);
    }
    ...
    public getProductDataFor() {
        return {
            productsToPurchase: <IProductToPurchase[]>[
                {
    ...
    public getDeltaRenewalsDataFor() {
        return {
            deltaRenewalsToPurchase: <IDeltaRenewalToPurchase[]>[
                {
    ...
    public getArgiOrAirBusinessRenewalsDataFor() {
        return {
            argiOrAirBusinessRenewalsToPurchase: <IArgiOrAirBusinessRenewalToPurchase[]>[
                {
                    email: 'test.elsevier.io+mc+renewals@gmail.com',
                    agentName: 'Ren Autom',
