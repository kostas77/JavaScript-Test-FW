    ...
    setDriverCapabilities() {
        ...
        switch (this.testServerURL) {
            case 'http://hub-cloud.browserstack.com/wd/hub':
                ...
                this.capabilitiesDict['browserstack.networkLogs'] = 'true';
                ...
                break;
            case 'http://hub.crossbrowsertesting.com:80/wd/hub':
                this.capabilitiesDict['username'] = process.env.CBT_USERNAME;
                this.capabilitiesDict['password'] = process.env.CBT_AUTH_KEY;
                this.capabilitiesDict['name'] = process.env.test_tag;
                this.capabilitiesDict['record_video'] = 'true';
                this.capabilitiesDict['record_network'] = 'true';
                break;
        ...
        switch (this.browserName.toLowerCase()) {
            ...
            case 'ipad':
                ...
                this.capabilitiesDict['browserstack.appium_version'] = '1.14.0';
                break;
            case 'iphone':
