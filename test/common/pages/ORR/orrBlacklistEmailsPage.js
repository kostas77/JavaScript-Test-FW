...
class OrrBlacklistEmailsPage {
    ...
    blacklistEmailHeader(driver) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield helpers_1.Helpers.getElement(driver, this.blacklistEmailHeaderLocator);
        });
    }
}
exports.OrrBlacklistEmailsPage = OrrBlacklistEmailsPage;
//# sourceMappingURL=orrBlacklistEmailsPage.js.map